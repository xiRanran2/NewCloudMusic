<template>
  <div
    ...
    class="bg-[#444] text-[white] dark:bg-[#f1f1f1] dark:text-[#1a1c23]"
  >
    <header
    ...
    >
      <span @click="HomeView">
        <Icon icon="material-symbols:navigate-before" class="text-[8vw]" />
      </span>
      <div v-if="over">
        <span
          class="text-[#fff] w-[58vw] bg-[#444] dark:bg-[#966951] text-[5vw]"
          >歌单</span
        >
      </div>
      <div v-else class="flex items-center w-[67vw]">
        <van-notice-bar
          scrollable
          :text="songlist.name"
          class="text-[#fff] w-[58vw] bg-[#444] dark:bg-[#966951]"
        />
        <div
          class="w-[16.6vw] h-[7.67vw] rounded-[5vw] flex justify-center items-center ml-[2.48vw] text-[3.16vw]"
          style="background: rgba(255, 255, 255, 0.2)"
        >
          <Icon
            class="w-[3.08vw] h-[3.19vw] mr-[1.35vw]"
    ...
    <div class="mt-[15vw] dark:bg-[#966951] dark:text-[#fff]">
      <div ref="wrapper" class="relative">
          ...
          <div class="flex ml-[5vw] h-[30vw]">
            ...
            <div class="flex flex-col m-[3vw]">
              ...
              <div class="flex items-center mt-[2vw]">
                ...
                />
                <p class="ml-[1.5vw] text-[2.5vw]">
                  {{ songlist.creator?.nickname }}
                </p>

                <div
                  class="w-[14vw] ml-[3vw] h-[6vw] rounded-[5vw] bg-[#787878] dark:bg-[#ba957e] relative"
                >
                  <div
                    class="flex w-[14vw] h-[6vw] justify-center absolute top-0 left-0 items-center"
                  >
        ...
        <div v-if="display" class="transition-all fade-in h-[46vw]">
          ...
          >
            <span class="text-[2vw] text-[#c3c3c3] text-opacity-70"
              >喜欢这个歌单的用户也听了</span
            >
          </p>
            ...
            >
              <div v-for="item in music" :key="item.tom" class="w-[28vw]">
                <img
                  ...
                  alt=""
                  class="w-[28vw] h-[28vw] rounded-[3vw]"
                />
                <p class="line-clamp-2 text-[#fff] text-[3vw] mt-[2vw]">
                  {{ item.name }}
                </p>
              </div>
            </div>
        ...
        <span
          class="absolute top-[10px] right-[7px] w-[5vw] h-[5vw] rounded-[50%] pr-[0.2vw] bg-[#787878] dark:bg-[#ba957e] flex transform rotate-180"
          @click="lb1"
      ...
      <!-- 播放列表 -->
      <div
        class="bg-[#636363] rounded-[4vw] m-auto mt-[4vw] dark:bg-[#fff] relative"
      >
          ...
          >
            ...
            <div class="text-[6vw] flex">
              <Icon
                ...
                class="mr-[4vw] text-[#fff] dark:text-[black]"
              />
              <Icon
                icon="solar:list-down-outline"
                class="text-[#fff] dark:text-[black]"
              />
            </div>
          </div>
        </div>
          ...
          >
            <div class="flex items-center">
              <img
                ...
                src="../../static/wave.gif"
              />
              <span v-else class="text-[#9a9a9a]">{{ indexs + 1 }}</span>
...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      ...
      this.over =
        scrollTop > this.$refs.wrapper.offsetHeight / 2 ? false : true;
    },
    playAll() {
