<template>
  <div class="h-screen">
    <div class="p-[6.15vw]">
      ...
      <div
        v-if="state === 801"
        class="relative flex justify-center items-center flex-col h-full"
      >
      ...
      >
        <img :src="qrcode" alt="Image" class="my-auto w-[40vw] h-[40vw]" />
        <div
          class="absolute flex-col w-[40vw] h-[40vw] bg-[#fff] bg-opacity-80 top-0 flex justify-center items-center"
        >
          <div
            @click="fn"
