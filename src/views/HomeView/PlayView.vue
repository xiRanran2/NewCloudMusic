<template>
  <div class="w-screen h-screen bg-gradient-to-b from-[#132435] to-[#1b3a51]">
    <div class="w-[90.77vw] m-auto">
      ...
      <div class="flex justify-end h-[54.5vw]">
        <img
          src="../../static/needle-ab.png"
          class="pr-[3vw] w-[40.66vw] h-[42.5vw] mt-[4vw]"
        />
      </div>
      <!-- 黑胶唱片 -->
      ...
      <div class="flex items-center mt-[6vw] ">
        ...
        <vue-slider
          v-model="value"
        ></vue-slider>
        <span class=" text-[#586c71]">03:07</span>
      </div>
      <!-- 随机 上一首 播放 下一首 菜单 -->
      <div class="flex items-center justify-around text-[white] mt-[4.75vw]">
        ...
        <Icon icon="fontisto:play-list" class="text-[5.5vw]" />
      </div>
    </div>
  </div>
</template>
