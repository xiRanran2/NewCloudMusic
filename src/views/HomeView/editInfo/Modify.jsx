...
`
import { updateinfo, getUserAccount, nicknameCheck } from '@/request'
    ...
    render() {
        return (
            <div class='bg-[#e9ecec] dark:bg-[#151515]'>
                <div class=" w-screen  bg-[#fff] pt-[14vw]">
                    <div class="fixed bg-white shadow w-[100%] top-0">
                        <header class="flex  relative items-center justify-center w-[100%] box-border p-[4vw]">
                            <span onClick={this.toggleshow} class=" absolute left-[4vw] top-[50%] translate-y-[-50%]">
                    ...
                    <div class="pt-[2vw] w-screen bg-[#F6F6F6] text-[3.5vw]">
                        <ul class="bg-[#fff] py-[2vw] pl-[4vw] ulList" >
                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]" >
                                ...
                                <div class="text-[#989898] flex items-center"> <img class="rounded-[50%] shadow h-[10vw] w-[10vw]" src={this.userinfo.avatarUrl} alt="" /></div>
                            </li>
                            <li onClick={() => { this.nickshow = true }} class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]">
                                <div><span>昵称</span></div>
                                <div class="text-[#989898] flex items-center"><span>{this.userinfo.nickname}</span><Icon class=" ml-[2vw] " icon="teenyicons:right-outline" /></div>
                            </li>
                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]" onClick={this.setsex}>
                                ...
                                <div class="text-[#989898] flex items-center"><span ref="sex" class="text-[#989898] flex items-center">{this.userinfo.gender == 1 ? '男' : this.userinfo.gender == 0 ? '保密' : '女'}</span><Icon class=" ml-[2vw] " icon="teenyicons:right-outline" /></div>
                            </li>

                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw]">
                                <div><span>二维码</span></div>
                                <div class="text-[#989898] flex items-center"><Icon icon="ph:qr-code-light" color="#989898" class="w-[5vw] h-[5vw] ml-[.25vw]" /><Icon class=" ml-[2vw] " icon="teenyicons:right-outline" /></div>
                            </li>
                        </ul>
                            ...
                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]">
                                ...
                                <div class="text-[#989898] flex items-center">
                                    <span class="text-[#989898] flex items-center">
                                        {new Date(this.userinfo.birthday).getFullYear()}-{new Date(this.userinfo.birthday).getMonth() + 1}-{new Date(this.userinfo.birthday).getDate()}
                                    </span>
                                    <Icon class=" ml-[2vw] " icon="teenyicons:right-outline" />
                                </div>
                            </li>
                            <li onClick={() => { this.cityshow = true }} class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]">
                                <div><span>地区</span></div>
                                <div class="text-[#989898] flex items-center"><span class="text-[#989898] flex items-center">{this.areaList.province_list[this.userinfo.province]} {this.areaList.city_list[this.userinfo.city]}</span>
                                    <Icon class=" ml-[2vw] " icon="teenyicons:right-outline" /></div>
                            </li>
                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]">
                                <div><span>大学</span></div>
                                <div class="text-[#989898] flex items-center"><span class="text-[#989898BF]">未填写</span>
                                    <Icon class=" ml-[2vw] " icon="teenyicons:right-outline" /></div>
                            </li>
                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]">
                                <div><span>音乐标签</span></div>
                                <div class="text-[#989898] flex items-center"><span class="text-[#989898BF]">选择标签</span>
                                    <Icon class=" ml-[2vw] " icon="teenyicons:right-outline" /></div>
                            </li>
                            <li class="flex flex-col ">
                                <div class="h-[12vw] flex  items-center border-b-[.1vw] border-solid border-[#cccccc80]"><span>简介</span></div>
                                <textarea class="h-[20vw]" placeholder="请输入个人介绍..." name="" id=""></textarea>
                            </li>
                        </ul>
                        <ul class="bg-[#fff] py-[2vw] pl-[4vw] mt-[2vw] ulList">
                            <li class="pr-[4vw] py-[2vw] flex justify-between items-center h-[12vw] border-b-[.1vw] border-solid border-[#cccccc80]">
                ...
                {/* 修改性别弹出层 */}
                <van-popup v-model={this.sexshow} class="flex h-[30vh] flex-col" position="bottom">
                    <popstyle>
                        <van-picker columns={this.columnsarr} onCancel={this.cancel} onConfirm={this.confirm} show-toolbar confirmButtonText='完成'></van-picker>
                    </popstyle>
                </van-popup>
                ...
                <van-popup class="  " v-model={this.nickshow} position="bottom">
                    <div class="bg-[#f8f8f8] h-screen">
                        <header class="flex items-center justify-between box-border p-[4vw] bg-white">
                            <div onClick={this.closenameshow} class=" text-[14px]">取消</div>
                            <div class=" font-[550]">修改昵称</div>
                            <div onClick={this.setnickname} class="text-[#b2b2b2] text-[14px]">完成</div>
                        </header>
                        <div class="h-[12vw] flex items-start justify-start mt-[2vw]">
                            <input v-model={this.nickname} class="box-border pl-[4vw] h-[100%] caret-blue-600 bg-white w-[100%]" type="text" value={this?.userinfo.nickname} placeholder="请输入昵称" />
                        </div>
                        <p ref='nametitle' class="text-red-500 text-[14px] pl-[4vw] pt-[4vw] box-border"></p>
                    </div>
                </van-popup>
                ...
                <citywrap>
                    <van-popup v-model={this.cityshow} position="bottom">
                        <van-area title="标题" onCancel={this.closecity} onConfirm={this.citysub} area-list={this.areaList} columnsNum="2" />
                    </van-popup>
                </citywrap>
        ...
        nickname(newValue) {
            if (!this.debouncedFunc) {
                this.debouncedFunc = _.debounce(async () => {
                    try {
                        const res = await nicknameCheck(this.nickname);
